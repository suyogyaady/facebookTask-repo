...
#connecting our database to sqlite
...
#creating function to show records in the window.
def query():
    conn= sqlite3.connect("facebook.db")
    c=conn.cursor()
...
#creating function to delete existing records
def delete():
    conn=sqlite3.connect("facebook.db")
    c=conn.cursor()
...
#creating function to update the records.
def update():
    conn=sqlite3.connect("facebook.db")
    c=conn.cursor()
...
#creating function to change and save existing records.
def edit():
    global editor
    editor=Toplevel()
...
#creating entry box to fill up details
...
#creating label for the entry boxes
